...
import MyPageLeftTop from "./left/myPageLeftTops";
import MyPageLeftBottom from "./left/myPageLeftBottoms";
...
export default function MyPageLeft() {
  ...
  return (
    <LeftContainer>
      <MyPageLeftTop tabs={loginId === userId ? tabs : tabs.slice(0, 1)} />
      <MyPageLeftBottom tabs={tabs} />
    </LeftContainer>
  );
}
